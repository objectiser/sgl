 ...
 *
 */
package org.scribble.runtime.messaging.activemq.osgi;
...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext bundleContext) throws Exception {
		...
		MessagingLayer impl=new ActiveMQMessagingLayer();
		
		m_registration = context.registerService(MessagingLayer.class.getName(), 
						impl, props);
	}
