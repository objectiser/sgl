...
/**
 * This class provides the Else implementation of the
 * projector rule.
 */
public class ElseProjectorRule implements ProjectorRule {
	...
	public boolean isSupported(ModelObject obj) {
		return(obj.getClass() == Else.class);
	}
