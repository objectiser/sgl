...
public class PurchasingSupplier2 extends DefaultProcess {

	private static final long serialVersionUID = 3387504081020384080L;
	...
	public static String PROCESS_NAME="RequestForQuote-Supplier2";
	...
	private static final java.util.logging.Logger _log=
					java.util.logging.Logger.getLogger(PurchasingSupplier2.class.getName());
	...
	static {
		...
		PROCESS_PROPERTIES.put("supplierId", "supplier2");
	}
	...
	public PurchasingSupplier2(Endpoint endpoint) {
