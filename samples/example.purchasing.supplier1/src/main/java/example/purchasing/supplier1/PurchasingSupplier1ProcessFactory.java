...
public class PurchasingSupplier1ProcessFactory implements ProcessFactory {
	...
	public Process createProcess() {
		//return(new PurchasingSupplier1(new Endpoint(getName().toString(),
		//		java.util.UUID.randomUUID())));
		return(new PurchasingSupplier1_supplier(new Endpoint(getName().toString(),
				java.util.UUID.randomUUID())));
	}

	public String getName() {
		//return PurchasingSupplier1.PROCESS_NAME;
		return PurchasingSupplier1_supplier.PROCESS_NAME;
	}
	...
	public java.util.Properties getProperties() {
		return(PurchasingSupplier1.PROCESS_PROPERTIES);
	}
